    ...
    <div id="FooterMain" class="w-full bg-[#E8E8E8] mt-10 mb-2">
        <div class="max-w-[1200px] mx-auto px-4">
            ...
            <div class="md:flex gap-4 justify-between w-full">
                ...
                <div class="md:w-[50%] pt-4">
                    <div class="text-lg font-semibold text-[#282828]">MatinExpress Multi-language Sites</div>
                    <div class="text-[#999999] text-sm ">Pусский , Português , Español , Français , Deutsch , Italiano , Nederlands , Türk , 日本語, 한국어 , ภาษาไทย , tiếng Việt , اللغة العربي , עברית , Polish</div>
                </div>
            </div>

            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    <div class="text-lg font-semibold text-[#282828]">MatinExpress Group</div>
                ...
                <div class="md:w-[50%] pt-4">
                    <div class="text-lg font-semibold text-[#282828]">Search by Category</div>
                    <div class="text-[#999999] text-sm ">Top Sellers , Products , Promotions , Price , Cheap , Reviews , China Brands , Blog , Seller Portal , BLACK FRIDAY , AliExpress Assistant</div>
                </div>
            </div>
        </div>
    </div>
